...
from modules.face.face_detection import FastFaceDetection, AccuracyFaceDetection
...
class FaceAnalysis:
    ...
    def get(self, img, size_threshold=0, max_faces=10, receive_mode="meta", fast=True, mode="detect", face_image_size=112, crop_mode='arcface'):
