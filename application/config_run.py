...
def init_config(config_path):
    ...
    with open(config_path, 'r') as f:
        ...
        Config.enable_mongo = cfg_dict['enable_mongo']
        Config.mongo_host = cfg_dict['mongo_host']
        Config.mongo_port = cfg_dict['mongo_port']
        Config.mongo_username = cfg_dict['mongo_username']
        Config.mongo_password = cfg_dict['mongo_password']
        if 'mongo_database' in cfg_dict:
            Config.mongo_database = cfg_dict['mongo_database']

        if 'mongo_collection' in cfg_dict:
            Config.mongo_collection = cfg_dict['mongo_collection']
