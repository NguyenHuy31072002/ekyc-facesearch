...
import app.utils
import modules
from modules.driver import elasticsearch_driver, mongo_driver
...
def configure_logs(flask_app, config):
...
def config_driver(flask_app, config):
    if config.enable_es:
